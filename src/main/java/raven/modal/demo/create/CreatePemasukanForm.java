...
public class CreatePemasukanForm extends Form{
    public CreatePemasukanForm() {initComponents();}
    ...
    public void loadData(ServicePemasukan service, ModelTransaksi data) {
        try {
    ...
    private Component createForm(){
        ...
        txtTipeTransaksi.setText("Pemasukan");
