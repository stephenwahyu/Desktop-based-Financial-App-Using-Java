...
public class About extends JPanel {
    ...
    private void init() {
        ...
        JTextPane title = createText("Proyek Aplikasi Manajemen Keuangan");
    ...
    private String getDescriptionText() {
        String text = "\n" +
                "Aplikasi keuangan ini dibuat oleh anak magang dari Universitas Riau tahun 2025 sebagai bagian dari program magang di bidang pengembangan perangkat lunak. Kami berharap aplikasi ini dapat memberikan manfaat bagi pengguna dan menunjukkan kemampuan serta kreativitas para mahasiswa dalam menerapkan ilmu yang telah dipelajari selama di bangku kuliah.";
