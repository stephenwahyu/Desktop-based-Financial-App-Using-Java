        ...
        ModalDialog.showModal(this, new SimpleModalBorder(
                ...
                (controller, action) -> {
                    if (action == SimpleModalBorder.YES_OPTION) {
                        ...
                        // push modal
                        ModalDialog.pushModal(new SimpleModalBorder(new SimpleInputForms2(), "New Input Forms", SimpleModalBorder.YES_NO_OPTION, (control, act) -> {
                            if (act == SimpleModalBorder.YES_OPTION) {
