...
public class MyDrawerBuilder extends SimpleDrawerBuilder {
    ...
    public SimpleFooterData getSimpleFooterData() {
        return new SimpleFooterData()
                ...
                .setDescription("Version " + Demo.VERSION);
    }
...
//                new Item.Label("Beranda"),
//                new Item("Dashboard", "dashboard.svg", FormDashboard.class),
                new Item.Label("Menu"),
                new Item("Akun", "email.svg", FormAkun.class),
                new Item("Anggaran", "page.svg", FormAnggaran.class),
                new Item("Transaksi", "forms.svg")
                        .subMenu("Pemasukan", FormPemasukan.class)
                        .subMenu("Pengeluaran", FormPengeluaran.class),
//                new Item("Jurnal Bank", "forms.svg")
//                        .subMenu("Penerimaan Bank", FormPenerimaanBank.class)
//                        .subMenu("Pengeluaran Bank", FormPengeluaranBank.class),
                new Item.Label("Laporan"),
                new Item("Laporan Akutansi", "components.svg")
                        .subMenu("Jurnal", FormJurnal.class)
                        .subMenu("Neraca", FormNeraca.class)
                        .subMenu("Laba Rugi", FormLaba.class)
                        .subMenu("Arus Kas", FormArusKas.class),
